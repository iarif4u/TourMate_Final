...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileSet = (ImageView) findViewById(R.id.imageView);
        imageName = preference.getUserData(Constant.IMAGE);
        imageView = FileSystem.loadBitmap(this,imageName);
        try {
            profileSet.setImageBitmap(imageView);
        }catch (Exception ex){
            Log.d("Image_Name:", String.valueOf(ex));
